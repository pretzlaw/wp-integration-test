...
/**
 * RecoversMetaDataAfterTest
 *
 * @covers \Pretzlaw\WPInt\Mocks\MetaData
 */
class RecoverAfterTest extends MetaDataTestCase
{
	public function testRecoversOriginalValueAfterTest()
	{
		...
		// Returns to previous mock or null value
		$this->assertMetaDataIsUnchanged('existing');
	}
}
